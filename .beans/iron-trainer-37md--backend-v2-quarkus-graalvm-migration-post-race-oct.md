...
**Decision (Viktor, 2026-07-15): not waiting until October — migration starts NOW, in phases.** Post-race caution note superseded; strangler discipline still applies (working product stays working).
